                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-column gap-20 blog-image-div">
                                ...
                                <div class="upload-file">
                                    <input type="file" name="image" class="upload-file__input single_file_input" data-max-size="{{ getFileUploadMaxSize() }}"
                                           accept="{{getFileUploadFormats(skip: '.svg')}},image/*" data-required-msg="{{ translate('Thumbnail_is_required') }}">
                                ...
                                <p class="fs-10 mb-0 text-center">Image Format : {{getFileUploadFormats(skip: '.svg')}} <br> Image size : Max 2 MB <span class="fw-medium">(325 x 100 px)</span></p>
