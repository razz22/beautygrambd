                ...
                <div class="card-body">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-column gap-20">
                                ...
                                <p class="fs-10 mb-0 text-center">
                                    {{ 'JPG, JPEG, PNG, Gif Image size : Max 2 MB' }}
                    ...
                    <div class="d-flex flex-wrap gap-3 justify-content-end mt-4">
                        <button type="button" id="reset"
                                class="btn btn-secondary reset-form clear-draft">{{ translate('clear_draft') }}</button>
                        <button type="button" class="btn btn-outline-primary save-draft">{{ translate('Save_to_Draft') }}</button>
                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#toggle-status-publish-modal">{{ translate('Update_Publish') }}</button>
                    </div>
                </div>
            </div>
        </form>
