                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-column gap-20">
                                ...
                                <div class="upload-file">
                                    <input type="file" name="image"  data-required-msg="{{ translate('thumbnail_image_is_required') }}" class="upload-file__input single_file_input" accept="{{getFileUploadFormats(skip:'.svg')}}/image/*" value="" {{ empty(getStorageImages(path: $blog?->thumbnail_full_url, type:'backend-product') || getStorageImages(path: $blog?->draft_thumbnail_full_url, type:'backend-product')) ? 'required' : '' }}>
                            ...
                            @foreach($languages as $lang)
                                <div class="{{$lang != $defaultLanguage ? 'd-none':''}} form-system-language-form" id="{{$lang}}-form">
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="title[{{$lang}}]" class="form-control" id="title" data-required-msg="{{ translate('title_field_is_required') }}" value="{{ $defaultLanguage == $lang ? $blog->title :  $translate[$lang]['title'] ?? ''}}" placeholder="{{translate('ex').':'.translate('LUX')}}" {{$lang == $defaultLanguage ? 'required':''}}>
                                    </div>
                                </div>
                                ...
                                <div class="form-group mb-0 {{$lang != $defaultLanguage ? 'd-none':''}} form-system-description-language-form" id="{{ $lang}}-description-form">
                                    ...
                                    <textarea name="description[{{$lang}}]" id="description-{{$lang}}" style="display:none;"  data-required-msg="{{ translate('description_field_is_required') }}"  {{ $lang == $defaultLanguage ? 'required' : '' }}>{!! $defaultLanguage == $lang ? $blog->description :  $translate[$lang]['description'] ?? '' !!}</textarea>
                                </div>
                            @endforeach
                        </div>
                    </div>
