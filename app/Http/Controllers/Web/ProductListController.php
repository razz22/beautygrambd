...
class ProductListController extends Controller
{
    ...
    public function default_theme($request): View|JsonResponse|Redirector|RedirectResponse
    {
        ...
        return view(VIEW_FILE_NAMES['products_view_page'], [
            'pageTitleContent' => ucwords(str_replace(['-', '_'], ' ', $pageTitleContent)) . ' ' . translate('products'),
            'products' => $products,
            'data' => $data,
    ...
    public function theme_aster($request): View|JsonResponse|Redirector|RedirectResponse
    {
        ...
        return view(VIEW_FILE_NAMES['products_view_page'], [
            'pageTitleContent' => ucwords(str_replace(['-', '_'],' ',$data['offer_type'] ?? $data['data_from'])).' '.translate('products'),
            'products' => $products,
            'data' => $data,
            'ratings' => $ratings,
            'selectedRatings' => $selectedRatings,
