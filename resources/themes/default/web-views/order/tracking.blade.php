    ...
    <div class="container pt-4 pb-5 rtl">
        ...
        <div class="card border-0 box-shadow-lg">
            <div class="card-body py-5">
                ...
                <ul class="nav nav-tabs media-tabs nav-justified order-track-info flex-nowrap overflow-x-auto">
                    <li class="nav-item">
                                        ...
                                        <div class="media-body">
                                            ...
                                            @if ($orderDetails->delivery_type == 'third_party_delivery')
                                                <div class="mt-1">
                                                    ...
                                                    <span class="d-flex align-items-center justify-content-sm-center text-wrap max-w-210px overflow-hidden">
                                                        <span class="text-muted fs-14 text-wrap">
                                                            {{translate('tracking_ID')}} :
                                                            <span class="fs-14 fw-semibold text-dark">
                                                                {{ $orderDetails->third_party_delivery_tracking_id }}
                                                            </span>
                                                        </span>
                                                    </span>
                                                </div>
