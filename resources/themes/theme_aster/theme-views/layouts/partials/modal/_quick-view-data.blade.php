                                ...
                                <div class="product__actions d-flex align-items-start gap-12">
                                    @if($product->product_type === 'physical')
                                        <a href="javascript:void(0)" style="--size: 35px; pointer-events: none;"
                                           class="border text-warning d-inline-flex align-items-center justify-content-center" data-bs-toggle="tooltip" title="{{ translate('Physical_Product') }}" data-bs-placement="left">
                                            <img width="20" height="20" src="{{ theme_asset('assets/img/icons/product-type.svg') }}" class="svg" alt="">
                                        </a>
                                    @else
                                        <a href="javascript:void(0)" style="--size: 35px; pointer-events: none;"
                                           class="border text-warning d-inline-flex align-items-center justify-content-center" data-bs-toggle="tooltip" title="{{ translate('Digital_Product') }}" data-bs-placement="left">
