                            ...
                            <div class="table-responsive">
                                <table class="table text-capitalize text-start align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-nowrap">{{translate('QTY')}}</th>
                                ...
                                <table class="table __table text-end table-align-middle text-capitalize">
                                    ...
                                    <tr>
                                        ...
                                        @if ($orderDetails['order_type'] == 'default_type')
                                            <th class="text-muted text-nowrap">{{translate('shipping')}}</th>
                                        @endif
                                        @if($orderDetails['tax_model'] == 'exclude')
                                            <th class="text-muted text-nowrap">{{ translate('tax') }}</th>
                                        @endif
                                        <th class="text-muted text-nowrap">{{translate('discount')}}</th>
                                        ...
                                        @endif
                                        <th class="text-muted text-nowrap">{{translate('total')}}
