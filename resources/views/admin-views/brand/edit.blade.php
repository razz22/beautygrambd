                                    ...
                                    <div class="d-flex flex-column gap-20">
                                        ...
                                        <div class="upload-file">
                                            <input type="file" name="image" id="brand-image" class="upload-file__input single_file_input"
                                                ...
                                                accept="{{getFileUploadFormats(skip: '.svg,.gif')}},image/*" data-required-msg="{{ translate('brand_image_is_required') }}"  value="">
                                            <label
                                        ...
                                        <p class="fs-10 mb-0 text-center">
                                            {{ translate('image_format') }} : {{ translate(getFileUploadFormats(skip: '.svg,.gif', asMessage: 'true')) }}
                                            <br>
