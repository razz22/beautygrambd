<form action="{{ route('admin.category.update') }}" method="POST" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate"
