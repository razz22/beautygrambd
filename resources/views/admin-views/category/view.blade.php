            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body text-start">
                        ...
                        <form action="{{ route('admin.category.store') }}" method="POST" enctype="multipart/form-data" class="form-advance-validation form-advance-inputs-validation form-advance-file-validation admin-category-store" novalidate="novalidate">
                            @csrf
                            <div class="row mb-20">
                                <div class="col-lg-6">
                                    <div class="bg-section rounded-8 p-20 w-100 h-100">
                                        ...
                                        <div class="form-group mb-3">
                                            <label class="form-label text-capitalize"
                                                   for="priority">{{ translate('priority') }} <span class="text-danger">*</span>
                                        ...
                                        <div class="d-flex flex-column gap-30">
                                            ...
                                            <div class="upload-file">
                                                <input type="file" name="image" id="category-image"
                                                       ...
                                                       accept="{{getFileUploadFormats()}},image/*"
                                                       data-required-msg="{{ translate('category_Logo_is_required') }}"
                                                       data-file-msg="{{ translate('Category Logo must be lees then 2MB') }}"
                                                       value="" required>
                                                <label
                                            ...
                                            <p class="fs-10 mb-0 text-center">
                                                {{ translate('image_format') }} :   {{getFileUploadFormats(skip: '.svg') }}
                                                <br>
