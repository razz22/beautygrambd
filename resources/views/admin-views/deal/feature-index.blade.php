                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6 mt-3">
                                        <label for="name"
                                               class="form-label">{{ translate('start_date') }}<span class="text-danger">*</span></label>
                                        <input type="date" name="start_date" id="start-date-time" data-required-msg="{{ translate('start_date_is_required') }}"  required class="form-control">
                                    </div>
                                    <div class="col-md-6 mt-3">
                                        <label for="name"
                                               class="form-label">{{ translate('end_date') }}<span class="text-danger">*</span></label>
                                        <input type="date" name="end_date" id="end-date-time"  required data-required-msg="{{ translate('end_date_is_required') }}" class="form-control">
                                    </div>
                                </div>
                            </div>
