                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.deal.flash') }}" method="post"
                            class="text-start form-advance-validation form-advance-inputs-validation form-advance-file-validation non-ajax-form-validate" novalidate="novalidate" enctype="multipart/form-data">
                            @csrf
                                                ...
                                                <div class="tab-pane fade {{ $lang == $defaultLanguage ? 'show active' : '' }}"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="title[]" class="form-control"
                                                            id="title"
                                                            placeholder="{{ translate('ex') . ':' . translate('LUX') }}"   data-required-msg="{{ translate('title_field_is_required') }}"
